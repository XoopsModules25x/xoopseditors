...
if (!defined("XOOPS_ROOT_PATH") || !$xoopsUser) exit(); // change by kris
$xoopsLogger->activated = false;

if ($_SESSION['module_dir'] != "system") {
    $IMConfig['base_dir'] = XOOPS_ROOT_PATH . "/uploads/" . $_SESSION['module_dir'] . "/image/";
} else {
    $IMConfig['base_dir'] = XOOPS_ROOT_PATH . "/uploads/";
}
...
*/
if ($_SESSION['module_dir'] != "system") {
    $IMConfig['base_url'] = XOOPS_URL . "/uploads/" . $_SESSION['module_dir'] . "/image/";
} else {
    $IMConfig['base_url'] = XOOPS_URL . "/uploads/";
}
...
*/
$IMConfig['maxWidth'][0] = 500;
$IMConfig['maxHeight'][0] = 500;
$IMConfig['maxWidth'][1] = 100;
$IMConfig['maxHeight'][1] = 100;
