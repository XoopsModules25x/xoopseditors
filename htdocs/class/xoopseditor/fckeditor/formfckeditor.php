 ...
 * @version         $Id: formfckeditor.php 5454 2010-10-08 09:13:16Z kris_fr $
 */

xoops_load('XoopsEditor');

class XoopsFormFckeditor extends XoopsEditor
{
    var $language;
    var $upload = true;
    var $width = "100%";
    ...
    function XoopsFormFckeditor($configs)
    {
